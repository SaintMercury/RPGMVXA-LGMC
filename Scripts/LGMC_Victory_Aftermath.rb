#==============================================================================
# 
# Бе Yanfly Engine Ace - Victory Aftermath v1.04
...
class Window_VictoryLevelUp < Window_Base
  ...
  def draw_arrows
    ...
    change_color(system_color)
    for i in 0..8
      draw_text(dx, dy, 24, line_height, "Би", 1)
      dy += line_height
    end
  end
